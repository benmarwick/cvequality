...
To demonstrate the use the functions with raw data we will use Galton's [(1886)](http://www.jstor.org/stable/2841583) observations of heights (in inches) of 934 children in 205 families. This is the same dataset that Pearson used when he introduced the $c_v$
...
kable(child_test_summary, caption =  "Summary of tests on the equality of CVs in child heights by gender")
```
...
For something a little different, let's look at measurements of 600 stone artefacts from archaeological sites in Berkshire, England dating to the Lower Paleolithic (Fox and Baker 2006).  
...
Is the length of the artefacts more variable than the other dimensions??
...
This results in `r miller_mlrt_test2$D_AD` for the test statistic, and a p-value of `r miller_mlrt_test2$p_value`. This p-value would lead us to reject the hypothesis of no difference in variance. So unlike the asymptotic test, this M-SLR test would conclude that the ELISA values _are_ significantly less variable than the other two groups, consistent with our osbervations of the plot. 



## References

Feltz, C. J., & Miller, G. E. (1996). An asymptotic test for the equality of coefficients of variation from k populations. _Statistics in Medicine_, 15(6), 647-658

Fox, William and Tony Baker. 2006. Dimensions of 600 Acheulean Handaxes from Furze Platt, Maidenhead, Berkshire, England. Online at http://ele.net/acheulean/FPatROM.htm.

Galton, F. (1886). Regression Towards Mediocrity in Hereditary Stature _Journal of the Anthropological Institute_, 15, 246-263. http://www.jstor.org/stable/2841583

Krishnamoorthy, K., & Lee, M. (2014). Improved tests for the equality of normal coefficients of variation. _Computational Statistics_, 29(1-2), 215-232.

Pearson, K. (1896). Mathematical Contributions to the Theory of Evolution. III. Regression, Heredity, and Panmixia. _Philosophical Transactions of the Royal Society of London_. Series A, Containing Papers of a Mathematical or Physical Character, 187, 253-318. Retrieved from http://www.jstor.org/stable/90707