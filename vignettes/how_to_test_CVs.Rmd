...
Marwick, B. and K. Krishnamoorthy `r format(Sys.Date(), "%Y")` cvequality: Tests for the Equality of Coefficients of Variation from Multiple Groups. R software package
version 0.1.3. Retrieved from {https://github.com/benmarwick/cvequality, on `r format(Sys.Date(), "%d/%m/%Y")`
...
Galton, F. (1886). Regression Towards Mediocrity in Hereditary Stature _Journal of the Anthropological Institute_, 15, 246-263. http://www.jstor.org/stable/2841583 \doi{10.2307/2841583}

Krishnamoorthy, K., & Lee, M. (2014). Improved tests for the equality of normal coefficients of variation. _Computational Statistics_, 29(1-2), 215-232. http://link.springer.com/article/10.1007/s00180-013-0445-2 \doi{10.1007/s00180-013-0445-2}
